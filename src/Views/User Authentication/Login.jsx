        ...
        <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
          ...
          <div class="p-5">
            <div class="flex flex-col gap-1">
              <button type="button" class="flex items-center justify-center transition duration-200 border border-gray-200 text-gray-500  py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal">
                <img class="size-6 mx-3" src="Google-Logo-Photoroom.png" alt="Google sign in" />
                <span>Sign In with Google</span>
              </button>
              <button type="button" class="flex items-center justify-center transition duration-200 border border-gray-200 text-gray-500  py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal">
                <img class="size-6 mx-3" src="github-mark.png" alt="Google sign in" />
              ...
              <div class="text-center sm:text-right whitespace-nowrap">
                <Link to="/Register">
                  <button class="transition duration-200 mx-1 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                    ...
                    <span class="inline-block ml-1">Create an account</span>
                  </button>
                </Link>
              </div>
            </div>

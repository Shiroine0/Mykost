    ...
    <div className="font-poppins flex flex-col p-10 w-full min-h-screen ">
      <div className="flex flex-col bg-white overflow-hidden">
        ...
        <div className="flex justify-between mt-4">
          <div className="font-poppins w-2/3">
            <div className="grid grid-flow-col grid-rows-3 gap-y-2 gap-x-5">
              <div className="">
            ...
            {showLabel && (
              <div className="grid grid-flow-col justify-end gap-3 mt-4">
                {/* buat cancelnya urg belom nambahin buat klo ke cancel nge reset */}
                <button onClick={toggleCancel} className="border rounded-md py-1 px-5 text-gray-700 border-gray-400 hover:bg-gray-100">
                  <label className="text-left text-sm font-medium">Cancel</label>
                </button>
                <button onClick={toggleSelesai} className="border rounded-md py-1 px-5 text-white bg-violet-500 hover:bg-violet-600">
                  <label className="text-left text-sm font-medium">Selesai</label>
                </button >
              </div>
            )}
            ...
            <div className="flex mt-2 flex-col gap-4">
              <input 
                  type="date" 
                  className="ml-4 my-2 border w-1/5 rounded-lg p-2" />
            </div>
            ...
            <div className="flex flex-col items-start justify-start w-full">
              <span className="text-3xl mb-2 font-bold">
                ...
                <div className="flex items-center flex-row w-fit gap-2 justify-between">
                  <span className="text-left text-xl mb-2 mt-3 font-bold">
                    Metode Pembayaran
                  </span>
                </div>
                <div className="ml-3 w-full flex flex-col items-start justify-start">
                  <span className="text-left text-xl mt-5 mb-2 font-bold">
                    Virtual Account
                  </span>
                  <div className="flex flex-row gap-2">
                    <div className="bg-gray-100 p-3 rounded text-center hover:bg-gray-200 cursor-pointer"><CgCreditCard className="text-5xl"/></div>
                    <div className="bg-gray-100 p-3 rounded text-center hover:bg-gray-200 cursor-pointer"><CgCreditCard className="text-5xl" /></div>
                    <div className="bg-gray-100 p-3 rounded text-center hover:bg-gray-200 cursor-pointer"><CgCreditCard className="text-5xl" /></div>
                    <div className="bg-gray-100 p-3 rounded text-center hover:bg-gray-200 cursor-pointer"><CgCreditCard className="text-5xl" /></div>
                  </div>
            ...
            <button
              type="button"
              className="hover:bg-[#5b4fdb] border-[#7165E3] bg-[#7165E3] mt-1 mb-3 w-full flex items-center justify-center transition border border-gray-200 text-white  py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal"
            >
              <span>Sewa</span>
            </button>
          </div>
          ...
          <div className="h-1/4 font-poppins w-1/3 ml-4 font-poppins shadow-lg border rounded-xl p-6 flex flex-col">
            ...
            <div className="flex flex-col w-full gap-2">
              ...
              <div className="flex flex-row justify-between items-center">
                <span className="text-sm">Biaya sewa kos</span>
              ...
              <div className="mt-4 mb-2 font-bold flex flex-row justify-between items-center">
                <span className="text-md">Total Pembayaran Pertama</span>
